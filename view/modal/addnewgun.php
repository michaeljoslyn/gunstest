    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id='newGunForm' name='newGunForm'>
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <input type="hidden" name='gunId' id='gunId' value>
                                <label for="gunName" class="form-label">Gun Name:</label>
                                <input type="text" class="form-control" name="gunName" id='gunName' placeholder="Gun Name">
                            </div>
                        </div>
                        <div class="col-6">
                            <label for="selectBasePistol" class="form-label">Base Pistol:</label>
                            <select class="form-select" name='selectBasePistol' id='selectBasePistol'>
                                <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name='selectBarrel' id='selectBarrel'>
                                    <?php
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name='selectMagazine' id='selectMagazine'>
                                    <?php
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name='selectReceiver' id='selectReceiver'>
                                    <?php
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name='selectSights' id='selectSights'>
                                    <?php
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id='saveGun'>Save</button>
            </div>
        </div>
    </div>
</div>
    ...
    $(function() {
        ...
        $('#saveGun').click(function() {
            $.ajax({
                type: "POST",
                url: "processes/class.php",
                data: $('#newGunForm').serialize() + '&action=saveGun&gunId='+$('#gunId').val(),
                success: function(data) {
                    refreshTable();
